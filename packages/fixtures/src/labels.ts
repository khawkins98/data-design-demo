...
const en: LabelSet = {
  ...
  actionBack: "Back",
  actionNext: "Next",
  actionSaveDraft: "Save as draft",
  wizardTitle: "Add disaster event",
  wizardProgressLabel: "Submission progress",
  stepEventBasics: "Event basics",
  stepLinkedEvents: "Linked events",
  stepAdditionalDetails: "Additional details",
  stepReview: "Review and save",
  stepRequired: "Required",
  stepOptional: "Optional",

  groupHazardDetails: "Hazard details",
  groupLocation: "Location",
  fieldNameLocal: "Name (local)",
  fieldNameEnglish: "Name (English)",
  fieldNationalId: "National ID",
  fieldGlideNumber: "Glide number",
  fieldEventUuid: "Event UUID",
  fieldOriginator: "Originator",
  fieldStart: "Start",
  fieldEnd: "End",
  fieldGeographicLevels: "Geographic levels",
  fieldSpatialFootprint: "Spatial footprint",
  valueNoSpatialData: "No spatial data defined",
...
const fr: LabelSet = {
  ...
  actionNext: "Suivant",
  actionSaveDraft: "Enregistrer comme brouillon",
  wizardTitle: "Ajouter un événement de catastrophe",
  wizardProgressLabel: "Progression de la soumission",
  stepEventBasics: "Informations de base",
  stepLinkedEvents: "Événements liés",
  stepAdditionalDetails: "Détails supplémentaires",
  stepReview: "Vérifier et enregistrer",
  stepRequired: "Obligatoire",
  stepOptional: "Facultatif",

  groupHazardDetails: "Détails de l'aléa",
  groupLocation: "Localisation",
  fieldNameLocal: "Nom (local)",
  fieldNameEnglish: "Nom (anglais)",
  fieldNationalId: "Identifiant national",
  fieldGlideNumber: "Numéro GLIDE",
  fieldEventUuid: "UUID de l'événement",
  fieldOriginator: "Émetteur",
  fieldStart: "Début",
  fieldEnd: "Fin",
  fieldGeographicLevels: "Niveaux géographiques",
  fieldSpatialFootprint: "Emprise spatiale",
  valueNoSpatialData: "Aucune donnée spatiale définie",
...
const de: LabelSet = {
  ...
  /*
   * German is the overflow locale, and these are where a stepper breaks: a step
   * label under an icon in a fixed-width column has nowhere to put
   * "Zusätzliche Einzelheiten". Not shortened for that reason.
   */
  actionBack: "Zurück",
  actionNext: "Weiter",
  actionSaveDraft: "Als Entwurf speichern",
  wizardTitle: "Katastrophenereignis hinzufügen",
  wizardProgressLabel: "Fortschritt der Einreichung",
  stepEventBasics: "Ereignisgrunddaten",
  stepLinkedEvents: "Verknüpfte Ereignisse",
  stepAdditionalDetails: "Zusätzliche Einzelheiten",
  stepReview: "Prüfen und speichern",
  stepRequired: "Erforderlich",
  stepOptional: "Optional",

  groupHazardDetails: "Angaben zur Gefahr",
  groupLocation: "Ort",
  fieldNameLocal: "Name (lokal)",
  fieldNameEnglish: "Name (englisch)",
  fieldNationalId: "Nationale Kennung",
  fieldGlideNumber: "GLIDE-Nummer",
  fieldEventUuid: "Ereignis-UUID",
  fieldOriginator: "Urheber",
  fieldStart: "Beginn",
  fieldEnd: "Ende",
  fieldGeographicLevels: "Geografische Ebenen",
  fieldSpatialFootprint: "Räumliche Ausdehnung",
  valueNoSpatialData: "Keine räumlichen Daten definiert",
...
const ar: LabelSet = {
  ...
  actionBack: "السابق",
  actionNext: "التالي",
  actionSaveDraft: "حفظ كمسودة",
  wizardTitle: "إضافة حدث كارثي",
  wizardProgressLabel: "تقدم الإرسال",
  stepEventBasics: "أساسيات الحدث",
  stepLinkedEvents: "الأحداث المرتبطة",
  stepAdditionalDetails: "تفاصيل إضافية",
  stepReview: "المراجعة والحفظ",
  stepRequired: "مطلوب",
  stepOptional: "اختياري",

  groupHazardDetails: "تفاصيل الخطر",
  groupLocation: "الموقع",
  fieldNameLocal: "الاسم (المحلي)",
  fieldNameEnglish: "الاسم (بالإنجليزية)",
  fieldNationalId: "المعرف الوطني",
  fieldGlideNumber: "رقم GLIDE",
  fieldEventUuid: "المعرف الفريد للحدث",
  fieldOriginator: "الجهة المُصدِرة",
  fieldStart: "البداية",
  fieldEnd: "النهاية",
  fieldGeographicLevels: "المستويات الجغرافية",
  fieldSpatialFootprint: "النطاق المكاني",
  valueNoSpatialData: "لا توجد بيانات مكانية محددة",
