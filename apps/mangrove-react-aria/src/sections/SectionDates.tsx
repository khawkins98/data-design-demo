 ...
 *
 * Compare with the MUI run, which has to compose two separate pickers because
 * its range components are commercially licensed.
 *
    ...
    <section className="demo-section" id="section-3" aria-labelledby="s3">
      ...
      <div className="demo-grid">
        ...
        {/*
          ...
          No `name` prop: DatePicker accepts one, DateRangePicker does not (it
          is not in its props type). Neither clears the axe `label` violation
          on the hidden inputs React Aria renders for form integration, which
          is therefore not fixable through the public API. See EVIDENCE.md.
        */}
        <DateRangePicker
