/**
 * Kitchen-sink page: React Aria Components inside the Mangrove host shell.
 *
            ...
            <div className={`${TOKEN_SCOPE_CLASS} demo`} data-locale={locale}>
              <header className="demo__header">
                ...
                <p className="demo__lede">
                  ...
                  fixtures inside the Mangrove host. The host elements above this
              ...
              <p className="demo__footnote">
                ...
                section. Arabic applies RTL through <code>I18nProvider</code>.
              </p>
