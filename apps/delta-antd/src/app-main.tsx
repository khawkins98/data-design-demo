 ...
 * absence of antd's `reset.css` — see the note there. That absence still matters
 * even though the candidate owns almost the whole viewport in this view: the
 * frame keeps a host strip below the application region, and antd's reset writes
 * to `html`, `body` and `*`, so it would reach it.
 *
