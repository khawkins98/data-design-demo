...
Production dependency tree for Ant Design 6.5.3 on the Delta host.

Measured with `pnpm --filter ./apps/delta-antd licenses list --prod`. The summary
...
| | |
| --- | --- |
| Production packages | **68** |
| Distinct licences | **1** |
| Licence breakdown | MIT 68 |
| Copyleft obligations | none |
| Font licences | none |

A single permissive licence across the entire production tree. That is the
cleanest licence position of any candidate in this evaluation.
...
| `@undrr-eval/host-delta` | workspace | Apache-2.0 | this repository: the host shell |
...
Workspace packages are this repository's own code and are not counted in the 68.
...
| --- | --- | --- |
| React Aria | 16 | Apache-2.0 8, MIT 7, 0BSD 1 |
| Mantine | 27 | MIT 25, 0BSD 1, (MIT OR CC0-1.0) 1 |
| **Ant Design** | **68** | **MIT 68** |
| Carbon | 78 | MIT 51, Apache-2.0 16, OFL-1.1 9, BSD-3-Clause 1, 0BSD 1 |
| MUI | 92 | MIT 87, BSD-3-Clause 3, ISC 2 |
