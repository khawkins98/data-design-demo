/**
 * Kitchen-sink page: Ant Design inside the Mangrove host shell.
 *
            ...
            <div className={`${TOKEN_SCOPE_CLASS} demo`}>
              <DemoContext.Provider value={demo}>
                ...
                <Typography.Paragraph type="secondary" style={{ maxWidth: "68ch" }}>
                  ...
                  inside the Mangrove host. The host elements above are the
                  leakage canaries and must be unaffected.
